    ...
    if (!userInfo) {
      ...
      const fetchData = async () => {
        try {
          ...
          setValue('subImage', data.subImage);
        ...
        <Grid container spacing={1}>
          ...
          <Grid item md={9} xs={12}>
            <Card sx={classes.section}>
              <List>
                <ListItem>
                  <Typography variant="h4">Edit Product {productId}</Typography>
                </ListItem>
                <ListItem>
                    ...
                    <List>
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <TextField
                              ...
                              error={Boolean(errors.image)}
                              helperText={
                                errors.image ? 'Sub Image is required' : ''
                              }
                              {...field}
                            ></TextField>
                          )}
                      ...
                      <ListItem>
                        <Button variant="contained" component="label">
                          ...
                          <input
                            type="file"
                            onChange={(e) => uploadHandler(e, 'subImage')}
                            hidden
                          />
                        </Button>
                        {loadingUpload && <CircularProgress />}
